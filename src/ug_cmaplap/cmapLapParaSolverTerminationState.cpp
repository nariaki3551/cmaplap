      ...
      )
{
   ...
   out.write(reinterpret_cast<char *>(&nParaTasksBkzReceived),          sizeof(int));
   ...
   out.write(reinterpret_cast<char *>(&runningTimeBkz),                 sizeof(double));
   ...
   out.write(reinterpret_cast<char *>(&nVectorsReceivedBkz),            sizeof(int));
      ...
      )
{
   ...
   in.read(reinterpret_cast<char *>(&nParaTasksBkzReceived),            sizeof(int));
