...
#ifndef __CMAP_TEST_PARA_SOLVER_H__
#define __CMAP_TEST_PARA_SOLVER_H__

#include "cmapLapParaSolver.h"


///
/// @class CMapTestParaSolver
///
class CMapTestParaSolver : public ParaCMapLAP::CMapLapParaSolver
{
...
public:
   ...
   virtual ~CMapTestParaSolver(
         );

};


#endif // __CMAP_TEST_PARA_SOLVER_H__
